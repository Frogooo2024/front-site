      ...
      <section class="detail-content">
        ...
        <div class="step-input-shadow">
          <div class="step-input">
            <img class="step-input-wrapper-image" src="../assets/icons/shein_5.png" alt="" />
          </div>
